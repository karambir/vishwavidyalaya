...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_student', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['school.School']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.school'
        db.delete_column('profiles_student', 'school_id')
