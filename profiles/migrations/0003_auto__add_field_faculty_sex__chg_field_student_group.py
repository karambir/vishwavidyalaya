...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faculty.sex'
        db.add_column('profiles_faculty', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=1),
                      keep_default=False)


        # Changing field 'Student.group'
        db.alter_column('profiles_student', 'group', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True))

    def backwards(self, orm):
        # Deleting field 'Faculty.sex'
        db.delete_column('profiles_faculty', 'sex')
