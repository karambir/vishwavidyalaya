...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faculty.timetable'
        db.add_column('profiles_faculty', 'timetable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.TimeTable'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Faculty.timetable'
        db.delete_column('profiles_faculty', 'timetable_id')
    ...
    models = {
        ...
        'profiles.faculty': {
            ...
            'timetable': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timetable.TimeTable']", 'null': 'True', 'blank': 'True'}),
