...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.total_attendance'
        db.add_column('academics_performance', 'total_attendance',
    ...
    def backwards(self, orm):
        # Deleting field 'Performance.total_attendance'
        db.delete_column('academics_performance', 'total_attendance')


        # Changing field 'Performance.attendance'
        db.alter_column('academics_performance', 'attendance', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        'academics.performance': {
            ...
            'attendance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'total_attendance': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'academics.section': {
