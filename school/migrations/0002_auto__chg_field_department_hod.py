...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Department.hod'
        db.alter_column('school_department', 'hod_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Faculty']))

    def backwards(self, orm):

        # Changing field 'Department.hod'
        db.alter_column('school_department', 'hod_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Faculty']))
