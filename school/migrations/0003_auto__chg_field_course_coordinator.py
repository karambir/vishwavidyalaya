...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.coordinator'
        db.alter_column('school_course', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Faculty'], null=True))

    def backwards(self, orm):

        # Changing field 'Course.coordinator'
        db.alter_column('school_course', 'coordinator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Faculty']))
