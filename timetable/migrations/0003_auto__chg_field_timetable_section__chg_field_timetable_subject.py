...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeTable.section'
        db.alter_column('timetable_timetable', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academics.Section'], null=True))

        # Changing field 'TimeTable.subject'
        db.alter_column('timetable_timetable', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academics.Subject'], null=True))

    def backwards(self, orm):

        # Changing field 'TimeTable.section'
        db.alter_column('timetable_timetable', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['academics.Section']))

        # Changing field 'TimeTable.subject'
        db.alter_column('timetable_timetable', 'subject_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['academics.Subject']))
    ...
    models = {
        ...
        'timetable.timetable': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['academics.Section']", 'null': 'True', 'blank': 'True'}),
