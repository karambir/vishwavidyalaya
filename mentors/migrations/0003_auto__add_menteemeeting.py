...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MenteeMeeting'
        db.create_table('mentors_menteemeeting', (
        ...
        db.send_create_signal('mentors', ['MenteeMeeting'])


    def backwards(self, orm):
        # Deleting model 'MenteeMeeting'
        db.delete_table('mentors_menteemeeting')
