...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mentor.group'
        db.alter_column('mentors_mentor', 'group', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Mentor.group'
        db.alter_column('mentors_mentor', 'group', self.gf('django.db.models.fields.CharField')(max_length=1))
