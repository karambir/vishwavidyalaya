...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mentee'
        db.create_table('mentors_mentee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Student'])),
            ('present_address_street', self.gf('django.db.models.fields.CharField')(max_length=350, null=True, blank=True)),
            ('present_address_city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('present_address_state', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('present_address_pincode', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('permanent_address_street', self.gf('django.db.models.fields.CharField')(max_length=350, null=True, blank=True)),
            ('permanent_address_city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('permanent_address_state', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('permanent_address_pincode', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('school_division', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('inter_division', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('degree_division', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('others_division', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('others_remarks', self.gf('django.db.models.fields.CharField')(max_length=350, null=True, blank=True)),
            ('family_member1_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('family_member1_relationship', self.gf('django.db.models.fields.CharField')(default='Father', max_length=20, null=True, blank=True)),
            ('family_member1_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('family_member1_qualification', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('family_member2_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('family_member2_relationship', self.gf('django.db.models.fields.CharField')(default='Father', max_length=20, null=True, blank=True)),
            ('family_member2_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('family_member2_qualification', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('family_member3_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('family_member3_relationship', self.gf('django.db.models.fields.CharField')(default='Father', max_length=20, null=True, blank=True)),
            ('family_member3_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('family_member3_qualification', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('family_member4_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('family_member4_relationship', self.gf('django.db.models.fields.CharField')(default='Father', max_length=20, null=True, blank=True)),
            ('family_member4_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('family_member4_qualification', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('family_member5_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('family_member5_relationship', self.gf('django.db.models.fields.CharField')(default='Father', max_length=20, null=True, blank=True)),
            ('family_member5_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('family_member5_qualification', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ...
            ('emergency_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('emergency_location', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('emergency_phone', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('mentors', ['Mentee'])

        # Deleting field 'MenteeMeeting.student'
        db.delete_column('mentors_menteemeeting', 'student_id')

        # Adding field 'MenteeMeeting.mentee'
        db.add_column('mentors_menteemeeting', 'mentee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mentors.Mentee']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Mentee'
        db.delete_table('mentors_mentee')

        # Adding field 'MenteeMeeting.student'
        db.add_column('mentors_menteemeeting', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Student']),
                      keep_default=False)

        # Deleting field 'MenteeMeeting.mentee'
        db.delete_column('mentors_menteemeeting', 'mentee_id')
